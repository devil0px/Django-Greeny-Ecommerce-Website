...
from .views import product_list_with_ajax,ProductList,ProductDetail,CategoryList,BrandList,BrandDetail,product_list,CategoryDetail,add_to_favourites,add_review
...
urlpatterns = [
    path('' , product_list_with_ajax, name='product_list'),
