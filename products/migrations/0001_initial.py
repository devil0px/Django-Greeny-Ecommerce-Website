# Generated by Django 3.2 on 2022-07-06 19:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='produc_Prand', to='products.brand', verbose_name='Prand')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='produc_Category', to='products.category', verbose_name='Category')),
            ],
        ),
        migrations.CreateModel(
            name='Reviews',
